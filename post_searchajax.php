					...
					<?php }?>
					  <div class="column">
					  		...
					  		<div style="width: 115px;margin: 5px; display: inline-block; float: left; vertical-align: top;">
								...
								<a href="" class="frdprofilee" id="<?php echo $val['id']; ?>"><img src="<?php echo $val['profile_path'] ?>" class="img-responsive"  style="width:113px; height:113px;"></a>
								<?php } else {?>
						    		<a href="" class="frdprofilee" id="<?php echo $val['id']; ?>"><img src='img/user.png' class='img-responsive' style="width:113px; height:113px;"></a>
						    	<?php }	?>
								</div>

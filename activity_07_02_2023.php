...
<form class="activity activity1" method="post" enctype="multipart/form-data" style="background: black !important; z-index: 999;">
                            ...
                            success:function(data){
                                              ...
                                              if(data.length>0){
                                                    ...
                                                    for( var i = 0; i < markers.length; i++ ) {
                                                        ...
                                                        let url = "https://maps.gstatic.com/mapfiles/ms2/micons/"+markers[i]['color']+"-pushpin.png";
                                                        var position = new google.maps.LatLng(markers[0]['lat'], markers[0]['lng']);
   		...
   		$(document).on("click", "#save_event", function(){ 
		    ...
		    else
		    {
		        $.ajax({
		            ...
		            data:{lat_location:lat_location,long_location:long_location,place_location:place_location,datetime:datetime,eventDisc:eventDisc},
		            success:function(result){ 
		                alert('You have successfully add event.');  
		                $('#eventDisc').val(''); 
		                $('#datetime1').val(''); 

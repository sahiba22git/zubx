				...
				<div class="row">
					<div class="col-xs-8">
					   ...
					   <div class="check">
						...
						<div class="check">
							<input type="checkbox" name="skill" id="searchskill" class="chk" onclick="checkskill(this.value);" > Skill 
						</div>
						<div>
					...
					<div class="col-xs-4 drop-padding">
				        <div class="skilllist" >
				        	<div>
				        		<label class="drop-list">Skill List</label>
				        		<select name="skillList" id="skillList" class="form-control less-padding-drop">
								<?php
	...
	function commonFilter(skill){
			...
			if($('#searchfemale').is(":checked")){
				...
				$.ajax({
					...
					data:{myfriend:myfriend,skill:skill,mybookmark:mybookmark,mymsg:mymsg,age_limit:age_limit,searchfemale:searchfemale,searchmale:searchmale},
...
<script type="text/javascript">
	...
	$('input[type="checkbox"]').click(function(){
		if($(this).val()=='all'){
						...
						if($('#searchskill').prop("checked") == false){
							...
							var skillList = $("#skillList option:selected").val();
							//var age_limit = $("#age_limit_post option:selected").val();
							console.log(skillList);
							$.ajax({
									type:"POST",
									url:"post_searchajaxinterst.php",
									data:{myfriend:myfriend, mybookmark:mybookmark, mymsg:mymsg,age_limit:age_limit,skillList:skillList,searchfemale:searchfemale,searchmale:searchmale,searchcoworker:searchcoworker,religion:religion},
									success:function(result){
									//	alert(result);
									//alert('post_searchajaxinterst/cell Interest clicked');
									$("#usersearch").html(result);
...
if ($('#searchageuser').prop("checked") == true)
		...
		if($('#searchskill').prop("checked") == true){
		$('.skilllist').show();
		commonFilter();
	}
...
<script type="text/javascript">
	...
	var skill = $("#skillList option:selected").val();
	//var age_limit = $("#age_limit_post option:selected").val();
	commonFilter(skill);
	return false;

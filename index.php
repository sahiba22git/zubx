...
if (isset($_POST['submit'])) {
	...
	if (($data==true or $data==1) and (count($data)>0)) {
		...
		$_SESSION['first_login'] = $data['first_login'];
		$_SESSION['user_id'] = $data['id'];
		$_SESSION['cell_id'] = $data['cell_id'];
		$_SESSION['loggedin'] = "You Are Logged IN";
		/*----last time login----*/
		$datetime = date('Y-m-d H:i:s');
		$fields = array('last_login','first_login');
		$values = array($datetime,'0');
...
$back_details = $user->select_allrecords("tbl_back", "back_path");
$bg_paths = array();
foreach ($back_details as $bg_path){
	$bg_paths[] = SITEPATH."".$bg_path['back_path'];
}
?>
<!doctype html>
<html>
...
<link rel="stylesheet" href="css/bootstrap-datetimepicker.min.css" media="all" >
...
$(document).ready(function() {
  var urls= <?php echo json_encode($bg_paths, JSON_PRETTY_PRINT) ?>;
			...
			<div class="links">
			 ...
			 <div class="copyright">
				  ...
				  <ul class="translation-links notranslate" > <!--notranslate-->
					 ...
					 <li class= "lanlist"><a href="#" class="hindi" data-lang="Hindi"> Hindi</a></li>
                     <li class= "lanlist"><a href="#" class="german" data-lang="German"> Deutsch</a></li>
...
<script type="text/javascript">
	function initMapp() {
		var input = document.getElementById('city_locationSignup');    
		             var autocomplete = new google.maps.places.Autocomplete(input);

               google.maps.event.addListener(autocomplete, 'place_changed', function () {
                    var place = autocomplete.getPlace();
                    document.getElementById('place_locationSignup').value = place.name;
                    document.getElementById('lat_locationSignup').value = place.geometry.location.lat();
                    document.getElementById('long_locationSignup').value = place.geometry.location.lng();
...
function googleTranslateElementInit() {
   new google.translate.TranslateElement({
        pageLanguage: 'en',
        includedLanguages: 'en,es,ru,ja,de,zh-CN,pt,it,fr,hi',
...
// Search popup result at index page
$("#SearchBeforeLogin").click(function(e){
		e.preventDefault();
		//alert();
		$(".search_box").show();
		$(".search_boxx").show();
	})
$("#close-window-search").click(function(e){
		e.preventDefault();
		//alert();
		$(".search_box").hide();
		$(".search_boxx").hide();
	})
$(".textInsearch").keyup(function(){
	//alert();
	$(".search_box").hide();
		$(".search_boxx").hide();
})

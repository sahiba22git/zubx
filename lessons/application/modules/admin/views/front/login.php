...
<body>
    ...
    <div class="login-register-link">
        <a href="<?php echo base_url(); ?>singup" class="ms-auto button register-now-btn">Register Now</a>
    </div>
            ...
            <div class="col-lg-6">
                <div class="login-form">
                    ...
                    <form action="<?php echo base_url(); ?>loginMe" method="post">
                        ...
                        <a href="<?php echo base_url() ?>forgotPassword" class="forgot-password ms-auto">Forgot my password?</a>

...
$item_id =  isset( $itemrecord->keyword_id) ? $itemrecord->keyword_id : '' ;
$item_name =  isset( $itemrecord->keyword_name ) ? $itemrecord->keyword_name : '' ;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Keyword Management
		<?php
		
			// print_r($_POST) ;
		
		?>
        <small>Add / Edit Keyword</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Keyword Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" action="<?php echo base_url() ?>admin/keyword/addEditKeyword" method="post" id="editqty" role="form">
                        <div class="box-body">

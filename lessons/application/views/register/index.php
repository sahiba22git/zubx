    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="login-form create-ac-form">
                ...
                <form action="<?php echo base_url('create-account');?>" method="post" id="registerForm" novalidate>
                    ...
                    <div class="form-step-1">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" class="form-control" name="name" id="fname" placeholder="What's your name" />
                        ...
                        <div class="position-relative">
                            ...
                            <input type="number" class="form-control" name="phone" id="pnumber" placeholder="What's your Phone number" />

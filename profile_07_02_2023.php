...
<div><?php if($_SESSION['user_id'] == $uid ) { ?> 
    ...
    <?php }?>
    <a class="uploadResume" id="Resume" usr="<?php echo $uid;?>" style="border:1px solid #000; cursor: pointer; padding:5px;"> Resume</a>
</div>
                    </div>
...
<script type="text/javascript">
   $(document).ready(function(){
        ...
        //$(".slidervideo").css("width:9%!important");
    });
$(".uploadResume").on("click",function(e){
    ...
    if(server=="localhost"){
        window.open("http://localhost/zuubox/resume.php?user="+usr_id, "_blank");
            }
            else{
                window.open("https://zuubox.com/resume.php?user="+usr_id, "_blank");
            }
    //window.open("http://localhost/zuubox/resume.php?user="+usr_id, "_blank");
   // window.open(server+"/resume.php?user="+usr_id, "_blank");

...
$obj_section = new Cellsection();
 ...
 // $where="section_id = 'slider'";
// $obj_sections = $obj_section->getcellsection('*', $where, '', '', 0);
$obj_sections = $obj_section->query("SELECT tbl_celldetails.*, tbl_cell.cell_name from tbl_celldetails LEFT JOIN tbl_cell ON tbl_celldetails.cell_id = tbl_cell.cell_id WHERE section_id = 'slider' ");
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
            <div class="col-lg-6">
                <h3 class="page-header text-primary"><i class="fa fa-th-list"></i> Manage Cell Slider</h3>
            </div>
            <div class="col-lg-6">

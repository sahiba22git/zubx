...
if (isset($_POST['submit']))
    {       
      ...
      /*------------------------------------*/
        ...
        $obj_section->insertcellsection(array("cell_id"=>$cellid,"section_id"=>'2',"section_2"=>$section2,"add-date"=>date("Y-m-d")));
...
if($_POST['update_type']=="edit")
{
    if(isset($_POST['submit']))
    {
        ...
        $update_data['section_2']=$_POST['section2'];
         $update_data['section_id']=2;
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <!-- add-user-action.php -->
                                            <form role="form" method="POST" enctype="multipart/form-data" action="#" name="add-form" id="addcellsection2">
                                                <?php
                                                    if(isset( $getevent))
                                                        {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" id="section2" name="section2" ><?php echo (isset($getsection['section_2'])) ? $getsection['section_2'] : ""; ?></textarea>
                                                </div>

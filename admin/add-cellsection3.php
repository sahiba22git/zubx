...
if (isset($_POST['submit']))
    {       
      ...
      /*------------------------------------*/        
        ...
        $obj_section->insertcellsection(array("cell_id"=>$cellid,"section_id"=>'3',"section_3"=>$section3,"add-date"=>date("Y-m-d")));
...
if($_POST['update_type']=="edit")
{
    if(isset($_POST['submit']))
    {
        ...
        $update_data['section_3']=$_POST['section3'];
        $update_data['section_id']=3;
...
<body>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <!-- add-user-action.php -->
                                            <form role="form" method="POST" enctype="multipart/form-data" action="#" name="add-form" id="addcellsection3">
                                                <?php
                                                    if(isset( $getevent))
                                                        {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" id="section3" name="section3"  ><?php echo (isset($getsection['section_3'])) ? $getsection['section_3'] : ""; ?></textarea>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        $("#addcellsection3").validate({
            rules: {
                cell:{
                    required: true
                },
                section3:{required: true}
            },
            messages: {
                cell: {

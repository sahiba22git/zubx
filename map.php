...
// ";
$query = "
select user_event.img_path,user_event.lat_location as lat, user_event.long_location as lng, event.color, user_event.place_location as place_name, user_event.content
from tbl_event_category_admin as user_event  
LEFT JOIN tbl_event_category as event on user_event.event_category_id = event.id    
";
             ...
             data:{without_act_id:without_act_id},              
              success:function(data){    
                                                    ...
                                                    for( var i = 0; i < markers.length; i++ ) {
                                                       ...
                                                       // console.log(marker)
                                                        let contentt = "<div class='map_info_wrapper'><a href='#'><div class='img_wrapper'><img src="+markers[i]['img_path']+" style='width:230px; height:149px;'></div>"+
                                                            ...
                                                            "<div class='property_title titlee2' style='font-weight:500; padding:5px;'>"+
						    ...
						    var boundsListener = google.maps.event.addListener((map), 'bounds_changed', function(event) {
						        this.setZoom(11);
                    var lat_init=parseFloat(28.394857);
                      var long_init=parseFloat(84.12400799999999);
...
function getMap(markers){
               ...
               var latlng = new google.maps.LatLng(parseFloat(42.745334), parseFloat(12.738430));
              // console.log("latlng");
               var map;
               //var markers=[];
                var bounds = new google.maps.LatLngBounds();
          ...
          stylers: [{ color: "#17263c" }],
                ...
                for( var i = 0; i < markers.length; i++ ) {
                                                        ...
                                                        marker = new google.maps.Marker({
                                                          ...
                                                          let contentt = "<div class='map_info_wrapper'><a href='#'><div class='img_wrapper'><img src="+markers[i]['img_path']+" style='width:230px; height:149px;'></div>"+
                                                          "<div class='property_content_wrap'>"+
                                                          "<div class='property_title titlee1' style='font-weight:500; padding:5px;'>"+
                                                          "<span>"+markers[i]['place_name']+"</span>"+
                                                          "</div>"+
                             ...
                             var boundsListener = google.maps.event.addListener((map), 'bounds_changed', function(event) {
                              this.setZoom(11);    	
                                                ...
                                                var boundsListener = google.maps.event.addListener((map), 'bounds_changed', function(event) {
                                                      ...
                                                      var lat_init=parseFloat(28.394857);
                                                      var long_init=parseFloat(84.12400799999999);
                                                      map.setCenter({lat:lat_init,lng:long_init});
                                                      google.maps.event.removeListener(boundsListener);
                                                    });
                                              }
